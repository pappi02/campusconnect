...
const PeopleAlsoViewedCarousel = ({ products }) => {
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
        {products.map((product) => (
          <Link
            ...
            className="bg-white rounded-2xl shadow p-4 relative group block"
          >
            {/* Discount badge */}
            {product.discount && (
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-gray-400 line-through text-base">
                Ksh {product.originalPrice ? product.originalPrice.toLocaleString() : "N/A"}
              </span>
            </div>
          </Link>
        ))}
...
export default PeopleAlsoViewedCarousel;
