        ...
        <div className="container">
          <nav className="navbar">
            ...
            <div className="nav-cta">
              <a href="/vendorlogin" className="btn btn-secondary">Vendor Login</a>
        ...
        <div className="container">
          <div className="cta-content">
            ...
            <div className="cta-buttons fade-in delay-2">
              <a href="#" className="btn btn-primary"><i className="fas fa-download"></i> Download App</a>
              <a href="/vendorlogin" className="btn btn-secondary"><i className="fas fa-store"></i> Vendor Sign Up</a>
            </div>
          </div>
        </div>
      </section>
