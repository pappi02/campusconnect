  ...
  return (
    <div className="max-w-5xl mx-auto p-6">
      ...
      <nav className="text-sm text-gray-600 mb-6">
        <Link to="/" className="hover:underline">Home</Link> {'>'} <Link to="/cart" className="hover:underline">Shopping Cart</Link> {'>'} <span>Payment Method</span>
      </nav>
...
export default CheckoutPaymentMethodPage;
